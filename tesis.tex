...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomrule=.15mm, breakable, rightrule=.15mm, coltitle=black, toprule=.15mm, toptitle=1mm, colback=white, leftrule=.75mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colbacktitle=quarto-callout-note-color!10!white]
