...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomrule=.15mm, leftrule=.75mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colback=white, opacityback=0, titlerule=0mm, colframe=quarto-callout-note-color-frame, left=2mm, coltitle=black, rightrule=.15mm, arc=.35mm, breakable, toprule=.15mm, bottomtitle=1mm]
