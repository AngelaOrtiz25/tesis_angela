...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacityback=0, left=2mm, toptitle=1mm, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomrule=.15mm, leftrule=.75mm, colback=white, bottomtitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, breakable, opacitybacktitle=0.6]
