...
las siguientes condiciones: 1. La función media es constante:
\(\mathbb{E}[X_t] = \mu\), para todo \(t \in \mathcal{T}\). 2. La
función de autocovarianza depende únicamente de la diferencia temporal
(lag): \(\operatorname{Cov}(X_t, X_s) = \gamma(|t-s|)\), para todo
\(t,s \in \mathcal{T}\). 3. La varianza es finita y constante:
...
coeficientes estimados y que se definirá más adelante {[}@{]}. Estos
enfoques son particularmente útiles cuando la longitud muestral es
limitada, como ocurre en ventanas de nowcasting de 7 días con muestreo
cada 10 minutos.
...
numérica frente a fluctuaciones de alta frecuencia
(\citeproc{ref-brockwell2016time}{Brockwell y Davis 2016}).
...
lugar de observaciones aisladas
...
\(L \in \mathbb{N}\) con \(L \ll T\), se definen los bloques
superpuestos: \[
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, bottomrule=.15mm, coltitle=black, leftrule=.75mm, rightrule=.15mm, colback=white, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacitybacktitle=0.6, opacityback=0, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm]
