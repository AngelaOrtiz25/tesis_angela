...
\item
  ...
  (\citeproc{ref-espectro-potencia}{\textbf{espectro-potencia?}}) y la
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, colback=white, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, bottomrule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}]
