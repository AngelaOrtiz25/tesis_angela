...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, colback=white, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, titlerule=0mm, leftrule=.75mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm]
