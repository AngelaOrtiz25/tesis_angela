...
fundamentales}\label{definiciones-fundamentales}
...
\section{Cadenas de Markov de tiempo
discreto}\label{cadenas-de-markov-de-tiempo-discreto}
...
ergódica}\label{distribuciuxf3n-estacionaria-y-convergencia-erguxf3dica}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, coltitle=black, opacityback=0, colback=white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, titlerule=0mm, breakable, arc=.35mm, left=2mm, bottomrule=.15mm, leftrule=.75mm]
