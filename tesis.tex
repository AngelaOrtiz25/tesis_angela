...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, breakable, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, colback=white, coltitle=black, left=2mm, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, toprule=.15mm]
