...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, arc=.35mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, colback=white, rightrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, leftrule=.75mm]
