...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, breakable, opacitybacktitle=0.6, toprule=.15mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacityback=0, bottomtitle=1mm, toptitle=1mm, colback=white, coltitle=black, bottomrule=.15mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}]
