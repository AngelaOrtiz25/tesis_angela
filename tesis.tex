...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, coltitle=black, opacityback=0, colback=white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, leftrule=.75mm, left=2mm]
