...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, toptitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, colback=white, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, rightrule=.15mm, left=2mm, bottomrule=.15mm, bottomtitle=1mm, breakable, coltitle=black, opacitybacktitle=0.6]
