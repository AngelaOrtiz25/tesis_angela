...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, arc=.35mm, colback=white, breakable, opacitybacktitle=0.6, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, leftrule=.75mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacityback=0, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame]
