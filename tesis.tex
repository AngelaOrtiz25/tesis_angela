...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, arc=.35mm, leftrule=.75mm, toptitle=1mm, left=2mm, titlerule=0mm, coltitle=black, rightrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomtitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame]
