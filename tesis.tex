...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, bottomtitle=1mm, left=2mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black, leftrule=.75mm, colback=white, breakable, bottomrule=.15mm, opacitybacktitle=0.6]
