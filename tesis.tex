...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, coltitle=black, colback=white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, left=2mm]
