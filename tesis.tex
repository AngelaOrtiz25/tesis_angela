...
\citeproc{ref-rincon2012procesos}{Rincón 2012a}).
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, rightrule=.15mm, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, toprule=.15mm]
...
---------. 2012a. \emph{Introducción a los procesos estocásticos}.
