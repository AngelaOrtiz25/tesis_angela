...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colframe=quarto-callout-note-color-frame, colback=white, toptitle=1mm, toprule=.15mm, breakable, coltitle=black, arc=.35mm, left=2mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, leftrule=.75mm, rightrule=.15mm, bottomtitle=1mm, opacityback=0]
