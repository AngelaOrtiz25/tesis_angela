...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, coltitle=black, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, breakable, colback=white, leftrule=.75mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
