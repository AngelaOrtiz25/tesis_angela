...
\begin{tcolorbox}[enhanced jigsaw, colback=white, arc=.35mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, leftrule=.75mm, rightrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, coltitle=black, breakable, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white]
