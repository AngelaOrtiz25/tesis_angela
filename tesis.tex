...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, arc=.35mm, left=2mm, colback=white, colframe=quarto-callout-note-color-frame]
