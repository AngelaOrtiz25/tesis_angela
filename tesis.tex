...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, leftrule=.75mm, bottomrule=.15mm, coltitle=black, arc=.35mm, bottomtitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, rightrule=.15mm, breakable, opacitybacktitle=0.6, titlerule=0mm, toprule=.15mm, colback=white, toptitle=1mm]
...
durante un período de 7 días (\(T = 1\,008\) observaciones), donde la
dependencia temporal constituye una característica estructural del
sistema atmosférico.

\section{Formulación matemática del block bootstrap
...
\subsection{Algoritmo de generación de
...
\section{Selección adaptativa de la longitud del
...
La implementación computacional del método se detalla en el Apéndice A,
donde se presentan las funciones principales del algoritmo. El código
