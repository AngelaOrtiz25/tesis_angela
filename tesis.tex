...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, breakable, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, coltitle=black, bottomtitle=1mm, opacityback=0, toprule=.15mm, toptitle=1mm, rightrule=.15mm, arc=.35mm, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
