...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, rightrule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, titlerule=0mm, bottomrule=.15mm, coltitle=black, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, bottomtitle=1mm, opacityback=0, breakable, colframe=quarto-callout-note-color-frame]
