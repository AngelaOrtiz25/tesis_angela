...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, colframe=quarto-callout-note-color-frame, opacityback=0, rightrule=.15mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm, breakable, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, leftrule=.75mm, colback=white]
