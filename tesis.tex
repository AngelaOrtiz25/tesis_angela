...
espacio de Hilbert
\(L^2(\Omega,\mathcal{F},\mathbb{P})\)}{Procesos estocásticos de segundo orden y espacio de Hilbert L\^{}2(\textbackslash Omega,\textbackslash mathcal\{F\},\textbackslash mathbb\{P\})}}\label{procesos-estocuxe1sticos-de-segundo-orden-y-espacio-de-hilbert-l2omegamathcalfmathbbp}
...
la Sección 2.1 se restringe a procesos de segundo orden, la
estacionariedad de interés es la \emph{débil} (o de covarianza), la cual
solo exige invarianza en los dos primeros momentos estadísticos
(\citeproc{ref-brockwell2016time}{Brockwell y Davis 2016}).
...
segmentos espaciales adyacentes, descrito en la Sección 4.3, y permite
estimar el tiempo de propagación de estructuras atmosféricas a lo largo
del corredor de vuelo (\citeproc{ref-box2015time}{Box et~al. 2015}).
...
\textbf{?@sec-sec-pronosticoadvectivo}, esta expresión se utiliza
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, rightrule=.15mm, coltitle=black, bottomtitle=1mm, left=2mm, opacityback=0, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, titlerule=0mm, toprule=.15mm, breakable, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6]
