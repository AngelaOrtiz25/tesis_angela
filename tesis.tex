...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, titlerule=0mm, toptitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, breakable, bottomtitle=1mm, arc=.35mm, left=2mm, leftrule=.75mm, colback=white, rightrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, coltitle=black]
