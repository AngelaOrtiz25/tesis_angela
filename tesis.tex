...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, arc=.35mm, leftrule=.75mm, breakable, colback=white, opacitybacktitle=0.6, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, coltitle=black, toprule=.15mm]
