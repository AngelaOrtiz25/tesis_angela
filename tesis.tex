...
En conjunto, la dualidad Atocovarianza--Transformada de Fourier cierra
...
numérica frente a fluctuaciones de alta frecuencia, paara más detalles
(\citeproc{ref-brockwell2016time}{Brockwell y Davis 2016}).
...
coeficiente de mezcla fuerte (strong mixing) del proceso \(\{X_t\}\): \[
...
\(L_{\text{opt}} \propto T^{1/3}\) para medias muestrales
...
por variable, como se detalla en la Sección 4.8.
...
(\citeproc{ref-politis1994large}{Politis y Romano 1994}).
...
error de Monte Carlo menor al \(1\%\)
(\citeproc{ref-lahiri2003resampling}{Lahiri 2003}).
...
desarrollada en la Sección 4.9. El uso del percentil 95 como cota
conservadora \(\tilde{y}_i = \text{p95}_i\) implementa una política de
tolerancia cero que cuantifica explícitamente el riesgo de violación de
umbrales técnicos, cerrando el ciclo entre teoría de procesos
estocásticos, remuestreo dependiente y toma de decisiones bajo
incertidumbre.
...
seguridad operacional (\citeproc{ref-berger1985statistical}{Berger
1985}).
...
\((\Theta, \mathcal{A}, \mathcal{L})\), donde: - \(\Theta\) es el
\textbf{espacio de estados de la naturaleza}, que en este contexto
corresponde al vector de condiciones meteorológicas reales futuras
...
de la decisión. En lugar de conocer el estado exacto, se dispone de una
...
procedimientos de remuestreo (\citeproc{ref-french1988decision}{French
1988}).
...
de pertenencia a un conjunto definido por intersección de semiespacios,
lo cual computacionalmente se resuelve mediante evaluaciones booleanas
secuenciales (\citeproc{ref-hillier2015introduction}{Hillier y Lieberman
2015}).
...
\(\mathbb{I}_{\text{vuelo}}\) desarrollada en la Sección 4.9. Los
umbrales técnicos \(u_j\) se derivan de las especificaciones del dron,
la región factible \(\mathcal{F}\) se construye como intersección de
restricciones univariadas, y el uso del percentil 95 (\(\alpha=0.05\))
materializa el conservadurismo del criterio de Wald en un contexto
estocástico. Esta formalización asegura que la recomendación operacional
no sea un heurístico empírico, sino una regla de decisión rigurosa,
trazable y alineada con los principios de la investigación de
operaciones aplicada a sistemas críticos.
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, opacitybacktitle=0.6, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, breakable, left=2mm, leftrule=.75mm, titlerule=0mm, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm]
...
\bibitem[\citeproctext]{ref-hillier2015introduction}
Hillier, Frederick S., y Gerald J. Lieberman. 2015. \emph{Introduction
to Operations Research}. 10.ª ed. New York: McGraw-Hill Education.
...
Liu, Regina Y., y Kesar Singh. 1992. {«Moving blocks jackknife and
bootstrap capture weak dependence»}. \emph{Exploring the Limits of
Bootstrap}, 225-48.
...
Politis, Dimitris N., y Joseph P. Romano. 1994. {«Large sample
