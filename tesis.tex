...
\subsection{Formulación formal del problema de
decisión}\label{formulaciuxf3n-formal-del-problema-de-decisiuxf3n}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, coltitle=black, colback=white, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, left=2mm, leftrule=.75mm, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, toptitle=1mm]
