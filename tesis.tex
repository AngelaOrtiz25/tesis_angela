...
\[
\sum_{i=1}^{124} \pi_i = 1, \quad \pi_i > 0 \; \forall i.
\]
...
se establece en las instalaciones de la Secretaria de Protección Civil
ubicadas en Tuxtla Gutiérrez, capital del estado de Chiapas
(https://maps.app.goo.gl/fRNWcaote5heu1Qp9). Esta localización responde
a criterios operativos fundamentales:
...
\item
  ...
  (https://maps.app.goo.gl/kip9Nrw984oCGX7ZA) mediante vía terrestre de
  alta capacidad.
\item
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, coltitle=black, breakable, opacitybacktitle=0.6, colback=white, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, left=2mm, bottomrule=.15mm]
