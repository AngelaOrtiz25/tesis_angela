...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, arc=.35mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, breakable, rightrule=.15mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, opacityback=0, colback=white, left=2mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm]
