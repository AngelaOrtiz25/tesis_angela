...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacityback=0, colback=white, leftrule=.75mm, arc=.35mm, toptitle=1mm, breakable, left=2mm, bottomtitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, titlerule=0mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white]
