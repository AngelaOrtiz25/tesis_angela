...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, titlerule=0mm, opacityback=0, breakable, leftrule=.75mm, toprule=.15mm, left=2mm, colback=white, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacitybacktitle=0.6, rightrule=.15mm]
