...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, breakable, opacityback=0, titlerule=0mm, arc=.35mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6]
