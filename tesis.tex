...
\chapter{Objetivos}\label{objetivos-1}
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, arc=.35mm, opacitybacktitle=0.6, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, colback=white, rightrule=.15mm, toprule=.15mm, left=2mm, leftrule=.75mm, breakable, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}]
