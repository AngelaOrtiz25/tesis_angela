...
aproximación es válida cuando \(\lvert \Delta h_i < \ll d_i^{(2D)}\),
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, bottomtitle=1mm, leftrule=.75mm, titlerule=0mm, toptitle=1mm, arc=.35mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, colback=white, left=2mm, rightrule=.15mm]
