...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, bottomrule=.15mm, left=2mm, rightrule=.15mm, leftrule=.75mm, arc=.35mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, colframe=quarto-callout-note-color-frame, colback=white, bottomtitle=1mm, titlerule=0mm, opacityback=0]
