...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, colback=white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, opacityback=0, breakable, toprule=.15mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, left=2mm, toptitle=1mm]
