...
adyacencia}\label{grafos-dirigidos-y-no-dirigidos-matrices-de-adyacencia}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, bottomtitle=1mm, left=2mm, coltitle=black, rightrule=.15mm, toprule=.15mm, arc=.35mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, colback=white, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white]
