...
y de la estructura de conectividad ponderada
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, colframe=quarto-callout-note-color-frame, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, leftrule=.75mm, left=2mm, breakable, bottomtitle=1mm, toprule=.15mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, colback=white]
