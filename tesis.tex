...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, titlerule=0mm, left=2mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, opacitybacktitle=0.6]
