...
PageRank}\label{aplicaciuxf3n-directa-al-algoritmo-pagerank}
...
\(|\gamma(h)| \leq \gamma(0)\) para todo \(h \in \mathbb{Z}\), - La
matriz de covarianza \(\Gamma_n = [\gamma(i-j)]_{i,j=1}^n\) es
...
\subsubsection{Definición formal de la operación de
concatenación}\label{definiciuxf3n-formal-de-la-operaciuxf3n-de-concatenaciuxf3n}
...
(\citeproc{ref-kuensch1989jackknife}{\textbf{kuensch1989jackknife?}}):
...
meteorología. \#\#\#\# Definición de las σ-álgebras de pasado y futuro
...
presencia de dependencia serial
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, left=2mm, breakable, toptitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, coltitle=black]
