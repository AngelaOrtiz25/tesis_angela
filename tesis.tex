...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, arc=.35mm, toptitle=1mm, left=2mm, leftrule=.75mm, coltitle=black, opacitybacktitle=0.6, breakable, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, rightrule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toprule=.15mm]
