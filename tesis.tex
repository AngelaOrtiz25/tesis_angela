...
donde \(P\) es la matriz de transición (Sección~\ref{sec-transicion2})
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, titlerule=0mm, opacityback=0, colback=white, bottomtitle=1mm, opacitybacktitle=0.6, coltitle=black, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm]
