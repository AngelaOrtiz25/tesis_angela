...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, colback=white, left=2mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, arc=.35mm, rightrule=.15mm, opacitybacktitle=0.6, coltitle=black]
