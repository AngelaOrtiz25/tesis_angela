...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, breakable, opacityback=0, colframe=quarto-callout-note-color-frame, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, left=2mm, titlerule=0mm, toprule=.15mm]
