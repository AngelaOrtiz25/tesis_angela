...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, rightrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, toprule=.15mm, arc=.35mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, leftrule=.75mm, opacityback=0]
...
\tightlist
\item
  \textbf{Ventana temporal óptima para evaluación}
\end{itemize}
...
\item
  \textbf{Umbrales de decisión conservadores}
\end{itemize}
