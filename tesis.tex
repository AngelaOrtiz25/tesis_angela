...
\emph{digrafo}) es un par ordenado \(D = (V, A)\), donde: - \(V\) es un
conjunto finito no vacío de vértices, - \(A \subseteq V \times V\) es un
conjunto de \emph{arcos}, cada uno representado como un par ordenado
\((u,v)\) con \(u, v \in V\) y \(u \neq v\).
...
https://gaia.inegi.org.mx/mdm6/ , obteniendo una discrepancia media
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, breakable, coltitle=black, rightrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, bottomtitle=1mm, arc=.35mm, left=2mm, bottomrule=.15mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacityback=0]
