...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, rightrule=.15mm, bottomrule=.15mm, coltitle=black, colback=white, breakable, toptitle=1mm, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, left=2mm, titlerule=0mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white]
