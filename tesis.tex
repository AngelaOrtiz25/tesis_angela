...
sitio oficial: {[}https://pyproj4.github.io/pyproj/stable/{]}. Esta
librería proporciona proporciona funciones optimizadas para geodesia
elipsoidal. La implementación garantiza consistencia numérica y
reproducibilidad, aspectos fundamentales para la validación científica
de los resultados.
...
{[}https://gaia.inegi.org.mx/mdm6/{]} , obteniendo una discrepancia
media inferior al \(1.2\%\). Las distancias 3D no pudieron validarse
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm]
...
\item
  ...
  Sección~\ref{sec-analisisadveccion} --
  \textbf{?@sec-cuantificacionbotstra}).
\item
