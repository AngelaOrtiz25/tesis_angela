...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, rightrule=.15mm, coltitle=black, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, opacityback=0, opacitybacktitle=0.6, colback=white]
