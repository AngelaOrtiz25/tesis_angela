...
respuesta rápida y efectiva ante situaciones críticas. ::: \{.columns\}
::: \{.column width=``50\%''\}

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/puente.png}
\emph{Figura 1a. Reconstrucción del puente sobre el Río Novillero en la
autopista costera Mapastepec--Tapachula, con participación de la Cámara
Mexicana de la Industria de la Construcción (CMIC). Fuente: Secretaría
de Infraestructura, Comunicaciones y Transportes (SICT), 2025.
Publicación en X: (\citeproc{ref-SICTmx}{\textbf{SICTmx?}}), 12 de junio
de 2025.}

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{chapters/caida_puente.png}
\emph{Figura 1b. Colapso del puente Tablazón I en la comunidad Ulapa,
municipio de Mapastepec, Chiapas, tras intensas lluvias. El evento formó
parte de una cadena de afectaciones que incluyeron el cierre de la
Carretera Costera (Mapastepec--Tapachula) y el colapso del puente
Pacayal. Fuente: Protección Civil Chiapas (2025).}
...
\subsection{Procedimiento de integración de datos}\label{nominatim2}
...
\item
  ...
  (\citeproc{ref-nominatim2}{\textbf{nominatim2?}})
\item
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-note-color-frame, colback=white, left=2mm, toprule=.15mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, coltitle=black, opacitybacktitle=0.6, bottomrule=.15mm]
