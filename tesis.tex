...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, coltitle=black, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm]
