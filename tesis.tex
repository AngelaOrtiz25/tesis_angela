...
El criterio de convergencia se basa en la norma \(\ell_1\) Kreyszig
(\citeproc{ref-kreyszig1989introductory}{1989}) entre iteraciones
consecutivas:
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomtitle=1mm, toprule=.15mm, left=2mm, toptitle=1mm, rightrule=.15mm, opacityback=0, bottomrule=.15mm, leftrule=.75mm, arc=.35mm, colback=white]
