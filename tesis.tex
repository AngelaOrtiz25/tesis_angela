...
estocásticos descritos en el Capítulo
Sección~\ref{sec-estocasticossegundo}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, opacityback=0, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, coltitle=black, arc=.35mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, colback=white, breakable]
