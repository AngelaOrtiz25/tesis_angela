...
\begin{tcolorbox}[enhanced jigsaw, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, left=2mm, titlerule=0mm, opacityback=0, opacitybacktitle=0.6, toptitle=1mm, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, colback=white, rightrule=.15mm, toprule=.15mm, arc=.35mm]
