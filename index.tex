...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm, rightrule=.15mm, opacityback=0, coltitle=black, bottomtitle=1mm, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6]
