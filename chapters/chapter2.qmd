...
En la implementación del sistema de nowcasting [@sec-sec-pronosticoadvectivo], esta expresión se utiliza directamente para calcular el componente autorregresivo:
$$
