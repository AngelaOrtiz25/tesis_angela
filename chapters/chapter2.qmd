...
Los modelos autorregresivos de orden uno constituyen la clase más simple y ampliamente utilizada de procesos estocásticos lineales. Su estructura recursiva captura la inercia temporal inherente a variables meteorológicas como la temperatura y la humedad relativa, permitiendo representar la persistencia observada en escalas de minutos a horas sin requerir parámetros adicionales. En el contexto de nowcasting, el modelo AR(1) proporciona el componente local del pronóstico híbrido descrito en la @sec-pronosticoadvectivo, complementando el transporte advectivo con dinámica temporal intrínseca y garantizando estabilidad numérica frente a fluctuaciones de alta frecuencia, para más detalles [@brockwell2016time].
...
#### Definición de la operación de concatenación
...
Estas discontinuidades son el precio a pagar por preservar la dependencia serial intra-bloque. Sin embargo, bajo las siguientes condiciones, su impacto en los estadísticos de interés es asintóticamente despreciable [@kunsch1989jackknife]:
...
#### Definición de las σ-álgebras de pasado y futuro
