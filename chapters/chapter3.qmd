...
El cálculo de distancias se implementó utilizando la librería `pyproj` (@pyproj_library) una interfaz de Python para la biblioteca de proyecciones cartográficas PROJ cuya documentación completa y ejemplos de uso pueden consultarse en su sitio oficial: [https://pyproj4.github.io/pyproj/stable/]. Esta librería proporciona  proporciona funciones optimizadas para geodesia elipsoidal. La implementación garantiza consistencia numérica y reproducibilidad, aspectos fundamentales para la validación científica de los resultados.
