...
### Matriz de transición modificada para PageRank {#sec-transicion}
...
Con estos ajustes, la matriz de transición mantiene la misma estructura ya mencionada en la @sec-transicion.
