...
![](puente_reconstruccion.jpg){width=50%}
...
- `obtener_coordenadas(ciudad)`: Obtiene las coordenadas geográficas de un municipio mediante Nominatim ver @#sec-nominatim2
