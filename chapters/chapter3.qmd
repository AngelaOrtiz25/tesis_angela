...
Esta expresión corresponde a la norma euclidiana en $\mathbb{R}^3$ del vector desplazamiento entre puntos consecutivos, proyectado sobre un sistema de coordenadas locales tangente a la superficie terrestre. La aproximación es válida cuando $\lvert \Delta h_i < \ll d_i^{(2D)}$, condición satisfecha en la mayoría de las rutas viales analizadas en el estado de Chiapas.
