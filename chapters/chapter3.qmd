...
![](puente.png){#fig-sict width="100%"}
*Figura 1a. Reconstrucción del puente sobre el Río Novillero en la autopista costera Mapastepec–Tapachula, con participación de la Cámara Mexicana de la Industria de la Construcción (CMIC). Fuente: Secretaría de Infraestructura, Comunicaciones y Transportes (SICT), 2025. Publicación en X: @SICTmx, 12 de junio de 2025.*

:::

::: {.column width="50%"}

![](caida_puente.png){#fig-tablazon width="100%"}
*Figura 1b. Colapso del puente Tablazón I en la comunidad Ulapa, municipio de Mapastepec, Chiapas, tras intensas lluvias. El evento formó parte de una cadena de afectaciones que incluyeron el cierre de la Carretera Costera (Mapastepec–Tapachula) y el colapso del puente Pacayal. Fuente: Protección Civil Chiapas (2025).*
...
### Procedimiento de integración de datos {#nominatim2}
...
- `obtener_coordenadas(ciudad)`: Obtiene las coordenadas geográficas de un municipio mediante Nominatim ver @nominatim2
