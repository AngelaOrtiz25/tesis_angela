...
La aplicación del block bootstrap con $B = 200$ réplicas generó intervalos de confianza del 90% ($p_{05}$–$p_{95}$) para cada variable meteorológica en los 15 segmentos espaciales de la ruta Aeropuerto hacia Protección Civil. Los resultados principales se resumen en la Tabla 4.1.
