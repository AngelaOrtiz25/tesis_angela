...
Para cada segmento $s_i$, se calcula la transformada de Fourier temporal [@sec-analisisfk]:
...
La incertidumbre del pronóstico se cuantificó mediante un procedimiento de **block bootstrap temporal** (@sec-blockbootstrap), que preserva la dependencia serial de las observaciones.
...
Como se mencionó en la @sec-grafosadyacencia se modela como un problema de optimización sobre la red (definido en la @eq-pi) de transporte terrestre $G = (V, E)$, donde $V$ representa los municipios y $E$ las conexiones viales. El algoritmo PageRank asigna a cada municipio $m_i$ un score de prioridad $\pi_i \in (0,1)$, definido por el sistema de ecuaciones:
...
2.  **Módulo de pronóstico**: Ejecución del modelo advectivo-híbrido con cuantificación de incertidumbre mediante block bootstrap @sec-analisisadveccion – @sec-cuantificacionbotstrap).

3.  **Módulo de decisión**: Evaluación de la función binaria $\mathbb{I}_{\text{vuelo}}$ contra umbrales técnicos del dron (@sec-drones).
...
### Recomendaciones operativas para implementación {.unnumbered}
...
#### Ventana temporal óptima para evaluación {.unnumbered}
...
#### Umbrales de decisión conservadores {.unnumbered}
...
#### Protocolos de contingencia escalonados {.unnumbered}
...
#### Integración con sistemas de monitoreo existentes {.unnumbered}
...
### Limitaciones del modelo actual {.unnumbered}
...
#### Dependencia de densidad de observaciones {.unnumbered}
...
#### Suposición de advección unidimensional {.unnumbered}
...
#### Estática de los umbrales técnicos {.unnumbered}
...
#### Independencia condicional entre variables {.unnumbered}
...
#### Optimización multiobjetivo dinámica {.unnumbered}
...
#### Aprendizaje automático híbrido {.unnumbered}
...
#### Redes complejas adaptativas {.unnumbered}
...
#### Coordinación de enjambres de drones {.unnumbered}
...
#### Asimilación de datos satelitales {.unnumbered}
...
#### Extensión geográfica a otras regiones {.unnumbered}
