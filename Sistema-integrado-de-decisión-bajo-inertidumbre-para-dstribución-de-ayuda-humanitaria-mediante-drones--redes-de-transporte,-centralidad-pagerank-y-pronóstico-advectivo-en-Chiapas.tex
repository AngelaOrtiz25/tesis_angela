...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, leftrule=.75mm, rightrule=.15mm, coltitle=black, bottomrule=.15mm, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, breakable, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, arc=.35mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, opacitybacktitle=0.6]
