...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, titlerule=0mm, opacitybacktitle=0.6, left=2mm, coltitle=black, opacityback=0, colback=white, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, rightrule=.15mm, breakable, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm]
