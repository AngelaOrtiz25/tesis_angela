...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, opacityback=0, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, rightrule=.15mm, breakable, colback=white, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomrule=.15mm, leftrule=.75mm, left=2mm, arc=.35mm, opacitybacktitle=0.6]
