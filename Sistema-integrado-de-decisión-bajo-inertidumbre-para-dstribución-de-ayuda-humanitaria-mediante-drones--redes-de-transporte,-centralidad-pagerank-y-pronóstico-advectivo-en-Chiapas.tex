...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, left=2mm, breakable, opacityback=0, rightrule=.15mm, coltitle=black, titlerule=0mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
