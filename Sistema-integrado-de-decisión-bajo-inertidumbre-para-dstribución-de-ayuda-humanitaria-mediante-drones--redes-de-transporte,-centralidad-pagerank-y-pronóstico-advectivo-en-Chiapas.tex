...
valor PageRank se presentan en la Tabla 3.1.

\subsection{Resultados obtenidos para la red de
Chiapas}\label{resultados-obtenidos-para-la-red-de-chiapas-1}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, coltitle=black, bottomtitle=1mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, leftrule=.75mm, left=2mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, breakable, colback=white, toptitle=1mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]
