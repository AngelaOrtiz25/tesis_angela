...
dstribución de ayuda humanitaria mediante dronesÑredes de transporte,
centralidad pagerank y pronóstico advectivo en
Chiapas}\label{sistema-integrado-de-decisiuxf3n-bajo-inertidumbre-para-dstribuciuxf3n-de-ayuda-humanitaria-mediante-dronesuxf1redes-de-transporte-centralidad-pagerank-y-pronuxf3stico-advectivo-en-chiapas}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, rightrule=.15mm, toptitle=1mm, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, breakable, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacityback=0, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, left=2mm]
