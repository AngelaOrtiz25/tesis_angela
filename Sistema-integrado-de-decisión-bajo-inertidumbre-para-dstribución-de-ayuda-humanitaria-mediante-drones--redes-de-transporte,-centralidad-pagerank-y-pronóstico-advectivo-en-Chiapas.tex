...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, breakable, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colframe=quarto-callout-note-color-frame, colback=white, bottomtitle=1mm, left=2mm, toptitle=1mm, opacitybacktitle=0.6, titlerule=0mm, rightrule=.15mm, opacityback=0, arc=.35mm, leftrule=.75mm, bottomrule=.15mm]
