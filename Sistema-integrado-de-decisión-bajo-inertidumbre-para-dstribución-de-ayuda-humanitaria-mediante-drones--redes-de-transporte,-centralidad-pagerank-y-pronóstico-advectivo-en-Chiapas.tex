...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, toptitle=1mm, arc=.35mm, rightrule=.15mm, breakable, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, left=2mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomrule=.15mm, bottomtitle=1mm, leftrule=.75mm]
