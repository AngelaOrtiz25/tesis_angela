...
\urlstyle{same}
\hypersetup{
  pdftitle={Sistema integrado de decisión bajo inertidumbre para dstribución de ayuda humanitaria mediante drones: redes de transporte, centralidad pagerank y pronóstico advectivo en Chiapas},
...
\title{Sistema integrado de decisión bajo inertidumbre para dstribución
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, breakable, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm]
