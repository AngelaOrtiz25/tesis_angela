...
Podría cuestionarse la elección de Tuxtla Gutiérrez como punto de
almacenamiento central dado que no ocupa los primeros lugares del
ranking PageRank. Sin embargo, esta decisión responde a criterios
operativos y logísticos independientes de la centralidad en la red vial.
En primer lugar, Tuxtla concentra la infraestructura necesaria para la
recepción de ayuda externa: el Aeropuerto Internacional Ángel Albino
Corzo, la sede estatal de Protección Civil y almacenes con capacidad
operativa. En segundo lugar, la ayuda humanitaria en situaciones de
emergencia proviene predominantemente de fuentes externas al estado
(gobierno federal, organismos internacionales, donaciones nacionales),
por lo que el punto de almacenamiento debe ubicarse en el nodo de
entrada natural de estos recursos, no necesariamente en el nodo más
central de la red interna. Finalmente, la metodología propuesta opera
bajo una logística jerárquica de dos niveles: Tuxtla funciona como
centro principal de recepción y despacho, mientras que los municipios
con mayor PageRank (San Cristóbal, Chamula, Rayón, entre otros)
funcionan como centros secundarios de redistribución regional. Esta
separación de funciones resuelve la aparente contradicción y refleja la
práctica real de los centros de coordinación de emergencias.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, opacityback=0, rightrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, coltitle=black, bottomrule=.15mm, left=2mm, titlerule=0mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, opacitybacktitle=0.6, colback=white]
