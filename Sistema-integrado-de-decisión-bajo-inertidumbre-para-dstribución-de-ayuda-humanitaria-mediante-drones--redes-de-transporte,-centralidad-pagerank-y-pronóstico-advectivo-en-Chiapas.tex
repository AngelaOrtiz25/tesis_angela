...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, titlerule=0mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6, left=2mm, rightrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, coltitle=black]
