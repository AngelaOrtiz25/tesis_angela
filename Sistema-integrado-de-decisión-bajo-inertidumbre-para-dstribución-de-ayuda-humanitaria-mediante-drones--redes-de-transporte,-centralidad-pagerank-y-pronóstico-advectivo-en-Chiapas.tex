...
(\textbf{?@sec-apendice-municipios}) de esta tesis.
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, breakable, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toptitle=1mm, opacitybacktitle=0.6, rightrule=.15mm, toprule=.15mm, titlerule=0mm, opacityback=0, coltitle=black, colframe=quarto-callout-note-color-frame]
