...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, coltitle=black, leftrule=.75mm, bottomrule=.15mm, breakable, colback=white, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, rightrule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6]
